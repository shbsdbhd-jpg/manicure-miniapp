...
function App() {
  const tg = window.Telegram?.WebApp; // безопасно через ?
  ...
  useEffect(() => {
    tg?.ready(); // вызываем ready один раз при монтировании
  }, []); // пустой массив зависимостей безопасен
  ...
  return (
    <div className="p-4 text-center">
      ...
      <button
        onClick={sendData}
        className="bg-pink-500 text-white rounded-xl px-4 py-2 mt-4"
      >
        Отправить
      </button>
    </div>
